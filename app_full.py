 ...
 "cells": [
  {
   ...
   "id": "c62f9494-1f46-4f42-8752-86d88ee544b2",
   "metadata": {},
   "outputs": [],
   "source": [
    "# === Tech Summary ===\n",
    ...
    "\n",
    "# ======================================== Userinterface Powered by Streamlit Package in Python =============================================================\n",
    "\n",
    "# === Tech Summary ===\n",
    "# This section initializes the user database (USER_DB).\n",
    "# - If a local JSON file (\"user_db.json\") exists, it loads user profiles from it.\n",
    "# - If the file doesn't exist, it creates a default user database in memory with two users (alice & bob).\n",
    "# - This database stores personal data like gender, age, height, weight, activity level, and goal.\n",
    "# - The logo_url is also defined here for use in the Streamlit interface.\n",
    "# =====================\n",
    "\n",
    "# --- Logo Link ---\n",
    ...
    "    \n",
    "# === Tech Summary ===\n",
    "# This section sets up the Streamlit page configuration and displays a custom header.\n",
    "# - The layout is centered using `st.set_page_config`.\n",
    "# - A two-column layout places the logo (left) and title + subtitle (right).\n",
    "# - The logo is loaded from a URL and resized.\n",
    "# - The header includes the app name, a short slogan, and a creator credit.\n",
    "# =====================\n",
    "\n",
    ...
    "\n",
    "# === Tech Summary ===\n",
    "# This section handles user login and registration using Streamlit widgets and session_state.\n",
    "# - Uses a JSON-based USER_DB to store user profiles (loaded earlier).\n",
    "# - If no user is logged in, a form appears to login or register:\n",
    "#   - Login: checks username and password, and updates session state.\n",
    "#   - Register: validates input, saves new user to file, and logs them in.\n",
    "# - All key user info (gender, age, weight, height, activity level, goal) is collected at registration.\n",
    "# - Uses st.session_state to persist user login across interactions.\n",
    "# =====================\n",
    "\n",
    "\n",
    "# --- Track login state ---\n",
    ...
    "\n",
    "# === Tech Summary ===\n",
    "# This section adds a sidebar component for logout and session feedback.\n",
    "# - If a user is logged in (`logged_in` is True and `username` exists), a message is shown.\n",
    "# - A \"Logout\" button clears all session state values when clicked, effectively logging out.\n",
    "# - This uses Streamlit's session_state to manage user session persistence and reset.\n",
    "# =====================\n",
    "\n",
    "# --- Sidebar logout ---\n",
    ...
    "    \n",
    "# === Tech Summary ===\n",
    "# This is the main post-login logic of the app. It integrates user data, calculations, and UI interaction:\n",
    "# 1. Retrieves user profile from session_state and displays it in the sidebar.\n",
    "# 2. Calculates:\n",
    "#    - BMR: Basal Metabolic Rate (kcal/day)\n",
    "#    - TEE: Total Energy Expenditure (kcal/day)\n",
    "#    - BMI: Body Mass Index (kg/m²)\n",
    "#    - burn_data: estimated distance and duration for burning 1/3 of TEE via different activities\n",
    "# 3. Allows the user to search for branded foods using a keyword (e.g., \"beef\").\n",
    "# 4. Queries the USDA API:\n",
    "#    - Step 1: search for fdcIds\n",
    "#    - Step 2: fetch detailed nutrient data\n",
    "# 5. Extracts nutrient info and calculates:\n",
    "#    - target macro distribution based on TEE and goal (e.g., muscle gain)\n",
    "#    - a nutrition score for each food item\n",
    "# 6. Displays:\n",
    "#    - Ranked results in a table\n",
    "#    - Radar charts comparing food nutrients to daily values (DV)\n",
    "# =====================\n",
    "\n",
